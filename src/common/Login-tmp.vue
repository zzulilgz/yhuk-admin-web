   ...
   <div>
     ...
     <div id="middle">
           <!--<li id="verifyCode" style="display: block;"><input id="valid" name="rand" placeholder="请输入验证码" maxlength="4">-->
             <!--<span id="validcode">-->
<!--<img id="verifyCodePic"  src="/img/jcaptcha.jpg" >-->
<!--</span>-->
             <!--<span id="changeimg">-->
<!--换一张-->
<!--</span></li>-->
           <el-form :model="loginData" label-width="100px" class="demo-ruleForm form-position">
             <ul style="text-align: center;">
               <li style="font-size: 48px">基础服务管理系统</li>
               <li><input class="name" v-model="loginData.loginName" placeholder="请输入用户名" /></li>
               <li><input type="password" v-model="loginData.password" class="pwd" placeholder="请输入密码" /></li>
           <li><button id="login" type="button" @click="login">立即登录</button></li>
...
<style>
  ...
  *{font-family:"微软雅黑"; margin:0; padding:0; border:0; font-size:14px;color:white;}
  ...
  .kuico{
    background:url(../assets/img/coolyun.png) no-repeat;
  ...
  .introduce{
    ...
    background: url(../assets/img/question.png) no-repeat 20px;
    text-indent: 20px;
    display: inline-block;
    height: 32px;
    line-height: 32px;
