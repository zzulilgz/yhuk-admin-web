<template>
  <section>
    <!-- path是中间的路由 -->
    <yhuk-breadcrumb :items="['权限管理','角色管理','角色列表']" path="/admin/role"/>
    <div style="width: 100%;margin-top: 30px">
      <el-form :inline="true" :model="queryReq" class="demo-form-inline"
               style="margin-left: 20px;display: inline-block">
        <el-form-item label="名称">
          <el-input v-model="queryReq.name" placeholder="请输入角色名称"></el-input>
        </el-form-item>
      </el-form>
    </div>
    ...
    <el-table :data="queryRes">
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          ...
          <!-- 额外功能 -->
          <el-button class="icon-shezhi" type="warning" round @click="openDialog('update',scope.row)"><i class="icon-shezhi" />权限设置</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="dialog.name+'角色'" :visible.sync="dialog.visible" width="500px">
      ...
      <template v-else>
        <el-form :model="saveReq" >
          ...
          <el-form-item label="备注" :label-width="'80px'">
            <el-input v-model="saveReq.remark" auto-complete="off"  type="textarea" style="width: 200px"></el-input>
          </el-form-item>
        </el-form>
      </template>
